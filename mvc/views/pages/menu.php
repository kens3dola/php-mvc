        ...
        <div class="d-flex justify-content-between align-content-between flex-wrap">
                ...
                ?>
                        <div class="card mb-5 ml-1 mr-1" style="min-width:15%; max-width:23%">
                                <form action="/php-mvc/order/cart/<?php echo $row['id'] . '/' . $row['price'] ?>" style="color:black" method="POST">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <p class="card-text mb-1"><label>Quantity: <input style="width:60%" type="number" name="quantity" value="1"></label></p>
                                        </div>
